...
const Hero = () => {
  ...
  return (
    <div className='bg-[#323232] w-full h-full'>
        <h1 className='title '>Your Experiential Event Production Partner</h1>
        <div>
        ...
        <div className='card py-5 md:py-14 '>
            {workcard.map(({id,src,title}) =>(
                <div key={id} className='card2'>
                   <div className='px-16 py-2'><img src={src} alt='/' className='rounded-md'/></div>
                   <div className='cardtext'><p>{title}</p></div>                   
                </div>
            ))}
        </div>
        <h1 className='title'>Here Are A Few Ways We Can Work Together</h1>
        <div className='card3 py-14'>
           {services.map(({id,title,sub}) =>(
            <div key={id} className='card3sub'>
        ...
        <div className='cardd3 py-14'>
           {hero.map(({id,src,title,sub,cont}) =>(
            <div key={id} className='card3sub'>
